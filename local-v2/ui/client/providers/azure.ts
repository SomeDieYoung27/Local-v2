import { z} from "zod";
import { BaseProviderSchema} from "./base";

export const AzureOpenAIConfigSchema = BaseProviderSchema.extend({
    model_provider : z.literal("azure-openai"),
    azure_openai_endpoint : z.string().nullable().optional().refine(
    ...
    azure_openai_api_version : z.string().nullable().optional().refine(
         (value) => value && value.trim() !== "",
...
export const DEFAULT_AZURE_OPENAI_CONFIG  : z.input<typeof AzureOpenAIConfigSchema> = {
